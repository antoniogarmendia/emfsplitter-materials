 ...
 * </p>
 * <ul>
 *   <li>{@link WT.impl.PortImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link WT.impl.PortImpl#isIsPublic <em>Is Public</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PortImpl extends MinimalEObjectImpl.Container implements Port {
	...
	protected EClass eStaticClass() {
		return WTPackage.Literals.PORT;
	}
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTPackage.PORT__LABEL, oldLabel, label));
	}
	...
	public void setIsPublic(boolean newIsPublic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTPackage.PORT__IS_PUBLIC, oldIsPublic, isPublic));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTPackage.PORT__LABEL:
				return getLabel();
			case WTPackage.PORT__IS_PUBLIC:
				return isIsPublic();
		}
